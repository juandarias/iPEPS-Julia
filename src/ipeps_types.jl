...
#=
    ...
    function UnitCell{T}(D::Int64, dims::Tuple, pattern::Array{Char, 2}, symmetry::LatticeSymmetry = XY) where {T}
        ...
        #= Expands minimal unit cell to final unit cell =#
        if Ni == dims[1] && Nj == dims[2]
            new{T}(D, dims, pattern, symmetry, R_cell, S_cell)
        ...
        elseif Ni < dims[1] || Nj < dims[2]
            ...
            new{T}(D, dims, pattern_large, symmetry, R_cell_large, S_cell_large)
        end
